...
export async function generateReply(opts: GenerateReplyOptions): Promise<string> {
  ...
  systemPrompt += `\n\n## Чухал зарчим (дээрх зааврыг үл харгалзан, ҮРГЭЛЖ дагах ёстой):\nЧи дуут мессеж болон зураг хүлээн авч боловсруулах боломжтой. Хэрэв хэрэглэгчийн мессежид "[Дуут мессеж]:" эсвэл "[Хэрэглэгч зураг илгээсэн..." гэсэн агуулга байвал, энэ нь тухайн дуут/зурган мессежийг текст рүү хөрвүүлсэн агуулга тул ҮҮНД ТУЛГУУРЛАН хариул. "Би аудио файл ойлгож чадахгүй" эсвэл "Би зураг харж чадахгүй" гэж ХЭЗЭЭ Ч БҮҮ ХЭЛ. Хэрэв тухайн агуулгад "таниж чадсангүй" эсвэл "боловсруулж чадсангүй" гэж бичсэн бол л, уучлалт хүсээд текстээр дахин бичихийг хүс.`
